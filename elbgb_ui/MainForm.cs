...
namespace elbgb_ui
{
    public partial class MainForm : Form, IInputSource
    {
        ...
        private void InitialisePalettes()
        {
            ...
            {
                {"default",         new uint[] {0x00FFFFFF, 0xFFB7B7B7, 0xFF686868, 0xFF000000} },

                // the following palettes from http://www.hardcoregaming101.net/gbdebate/gbcolours.htm
                {"dark yellow",     new uint[] {0x00FFF77B, 0xFFB5AE4A, 0xFF6B6931, 0xFF212010} },
                {"light yellow",    new uint[] {0x00FFFF94, 0xFFD0D066, 0xFF949440, 0xFF666625} },
                {"green",           new uint[] {0x00B7DC11, 0xFF88A808, 0xFF306030, 0xFF083808} },
                {"greyscale",       new uint[] {0x00EFEFEF, 0xFFB2B2B2, 0xFF757575, 0xFF383838} },
                {"stark b/w",       new uint[] {0x00FFFFFF, 0xFFB2B2B2, 0xFF757575, 0xFF000000} },
                {"gb pocket",       new uint[] {0x00E3E6C9, 0xFFC3C4A5, 0xFF8E8B61, 0xFF6C6C4E} },
            };
        }
