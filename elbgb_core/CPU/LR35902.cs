    ...
    public class LR35902
    {
        ...
        internal void ProcessInterrupts()
        {
            ...
            if (pendingInterrupt != 0)
            {
                ...
                if (_ime)
                {
                    ...
                    {
                        case VBlank: _pc = 0x0040; break;
                        case LCDCStatus: _pc = 0x0048; break;
                        case TimerOverflow: _pc = 0x0050; break;
                        case SerialIOComplete: _pc = 0x0058; break;
                        case Input: _pc = 0x0060; break;
                    }
                }
            }
        }
        ...
        public void ExecuteOpcode(byte opcode)
        {
            switch (opcode)
            {
                ...
                case 0x3E: _r.A = ReadByte(_pc++); break; // LD A,n
                case 0x06: _r.B = ReadByte(_pc++); break; // LD B,n
                case 0x0E: _r.C = ReadByte(_pc++); break; // LD C,n
                case 0x16: _r.D = ReadByte(_pc++); break; // LD D,n
                case 0x1E: _r.E = ReadByte(_pc++); break; // LD E,n
                case 0x26: _r.H = ReadByte(_pc++); break; // LD H,n
                case 0x2E: _r.L = ReadByte(_pc++); break; // LD L,n
                ...
                case 0x36: WriteByte(_r.HL, ReadByte(_pc++)); break; // LD (HL),n
                ...
                case 0xF0: _r.A = ReadByte((ushort)(0xFF00 + ReadByte(_pc++))); break; // LD A,($FF00+n)
                case 0xE0: WriteByte((ushort)(0xFF00 + ReadByte(_pc++)), _r.A); break; // LD ($FF00+n),A

                // load/store register A from/to internal RAM or register specified by 16-bit immediate
                case 0xFA: _r.A = ReadByte(ReadWord(_pc)); _pc += 2; break; // LD A,(nn)
                case 0xEA: WriteByte(ReadWord(_pc), _r.A); _pc += 2; break; // LD (nn),A
                ...
                case 0x01: _r.BC = ReadWord(_pc); _pc += 2; break; // LD BC,nn
                case 0x11: _r.DE = ReadWord(_pc); _pc += 2; break; // LD DE,nn
                case 0x21: _r.HL = ReadWord(_pc); _pc += 2; break; // LD HL,nn
                ...
                case 0x08: // LD (nn), SP
                    {
                        ...
                        WriteByte(address, (byte)(_sp));
                        WriteByte((ushort)(address + 1), (byte)(_sp >> 8));
                    } break;
                ...
                case 0xC6: _r.A = Add8Bit(_r.A, ReadByte(_pc++)); break;            // ADD n
                ...
                case 0xCE: _r.A = AddWithCarry8Bit(_r.A, ReadByte(_pc++)); break;    // ADC n
                ...
                case 0xD6: _r.A = Sub8Bit(_r.A, ReadByte(_pc++)); break;            // SUB n
                ...
                case 0xDE: _r.A = SubWithCarry8Bit(_r.A, ReadByte(_pc++)); break;    // SBC n
                ...
                case 0xE6: _r.A = And8Bit(_r.A, ReadByte(_pc++)); break;            // AND n
                ...
                case 0xF6: _r.A = Or8Bit(_r.A, ReadByte(_pc++)); break;            // OR n
                ...
                case 0xEE: _r.A = Xor8Bit(_r.A, ReadByte(_pc++)); break;            // XOR n
                ...
                case 0xFE: Compare8Bit(_r.A, ReadByte(_pc++)); break;                // CP n
                ...
                default:
                    throw new NotImplementedException($"Invalid opcode 0x{opcode:X2} at 0x{_pc - 1:X4}");
            }
        }
        ...
        private void Halt()
        {
            ...
            if (!_ime && (interruptFlag & interruptEnable & 0x1F) > 0)
            {
                _haltBug = true;
            }
            else
